...
await page.goto(`${BASE}/#/sc500/objectives/o1-1`, { waitUntil: 'networkidle' })
...
await page.goto(`${BASE}/#/sc500/objectives/o1-1/quiz?n=99`, { waitUntil: 'networkidle' })
...
if (totalQuizQuestions !== 40) fail('Quiz pool size', `expected 40 questions for sc500 o1-1, got ${totalQuizQuestions}`)
